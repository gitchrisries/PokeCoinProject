...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Pokecoin.AddBlockResponse();
  });
  ...
  describe('AddBlockResponse', function() {
    it('should create an instance of AddBlockResponse', function() {
      // uncomment below and update the code to test AddBlockResponse
      //var instance = new Pokecoin.AddBlockResponse();
      //expect(instance).to.be.a(Pokecoin.AddBlockResponse);
    });
